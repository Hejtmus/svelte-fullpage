...
var app = (function () {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<Fullpage> was created with unknown prop '${key}'`);
    	});
    ...
    function create_default_slot_22(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$8, 42, 5, 810);
    			add_location(p, file$8, 45, 5, 853);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot_19(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(39:1) <FullpageSection center>",
    		ctx
    	});
    ...
    function create_default_slot_5(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(95:1) <FullpageSection center>",
    		ctx
    	});
    ...
    // (98:1) <FullpageSection class="bg-warning" center>
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(98:1) <FullpageSection class=\\\"bg-warning\\\" center>",
    		ctx
    	});
