...
function create_default_slot_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			if (embed.src !== (embed_src_value = "https://www.npmjs.com/package/svelte-fullpage")) attr_dev(embed, "src", embed_src_value);
...
function create_default_slot_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(div, file$6, 66, 2, 1972);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t);
