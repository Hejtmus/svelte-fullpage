...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(li, "class", "svelte-fp-indicator-list-item svelte-1ydy3zy");
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(ul, "class", "svelte-fp-indicator-list svelte-1ydy3zy");
			add_location(ul, file, 126, 12, 4538);
			attr_dev(div0, "class", "svelte-fp-indicator svelte-1ydy3zy");
			add_location(div0, file, 125, 8, 4492);
			attr_dev(div1, "class", "svelte-fp-container svelte-1ydy3zy");
			add_location(div1, file, 123, 4, 4433);
			attr_dev(div2, "class", div2_class_value = "" + (null_to_empty(/*classes*/ ctx[3]) + " svelte-1ydy3zy"));
