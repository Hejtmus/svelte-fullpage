...
function create_default_slot_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(embed, "type", "application/html");
...
function create_default_slot_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(div, file$6, 66, 2, 1993);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, t);
