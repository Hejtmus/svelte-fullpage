...
function create_default_slot_5(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			if (embed.src !== (embed_src_value = "https://github.com/Hejtmus/svelte-fullpage#readme")) attr_dev(embed, "src", embed_src_value);
...
function create_default_slot_4(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h1, file$6, 97, 5, 2950);
			add_location(p, file$6, 98, 5, 2989);
		},
		m: function mount(target, anchor) {
			insert_dev(target, h1, anchor);
			append_dev(h1, t0);
