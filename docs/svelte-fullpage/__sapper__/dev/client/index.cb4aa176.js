...
function create_default_slot_5(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			iframe = claim_element(nodes, "IFRAME", { src: true, frameborder: true });
			children(iframe).forEach(detach_dev);
			this.h();
		},
		h: function hydrate() {
			if (iframe.src !== (iframe_src_value = "https://github.com/Hejtmus/svelte-fullpage#readme")) attr_dev(iframe, "src", iframe_src_value);
			attr_dev(iframe, "frameborder", "0");
			add_location(iframe, file$6, 92, 2, 2801);
		},
		m: function mount(target, anchor) {
...
function create_default_slot_4(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h1, file$6, 98, 5, 3047);
			add_location(p, file$6, 99, 5, 3086);
		},
		m: function mount(target, anchor) {
			insert_dev(target, h1, anchor);
			append_dev(h1, t0);
...
// (96:2) <Container class="text-center">
function create_default_slot_2(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(96:2) <Container class=\\\"text-center\\\">",
		ctx
	});
...
// (95:1) <FullpageSection sectionId="3" bind:activeSection class="bg-warning" center>
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(95:1) <FullpageSection sectionId=\\\"3\\\" bind:activeSection class=\\\"bg-warning\\\" center>",
		ctx
	});
