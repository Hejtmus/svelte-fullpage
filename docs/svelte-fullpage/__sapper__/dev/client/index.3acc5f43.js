...
function create_default_slot_4(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h1, file$6, 97, 5, 2902);
			add_location(p, file$6, 98, 5, 2941);
		},
		m: function mount(target, anchor) {
			insert_dev(target, h1, anchor);
			append_dev(h1, t0);
