...
${validate_component(Fullpage, "Fullpage").$$render(
			$$result,
			{
				sections,
				arrows: true,
			...
			{
				default: () => `${validate_component(FullpageSection, "FullpageSection").$$render(
					$$result,
					{
						sectionId: "0",
						center: true,
	...
	${validate_component(FullpageSection, "FullpageSection").$$render(
					$$result,
					{
						sectionId: "1",
						slides,
					...
					{
						default: () => `${validate_component(FullpageSlide, "FullpageSlide").$$render(
							$$result,
		...
		${validate_component(FullpageSlide, "FullpageSlide").$$render(
							$$result,
							{
								slideId: "1",
								class: "bg-danger",
	...
	${validate_component(FullpageSection, "FullpageSection").$$render(
					...
					{
						default: () => `<embed src="${"https://hejtmus.github.io/svelte-fullpage/"}" class="${"w-100 h-100"}">`
					}
				)}
	${validate_component(FullpageSection, "FullpageSection").$$render(
					$$result,
